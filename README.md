This site serves as a central hub for my technical write-ups, CTF walkthroughs, and security projects.

Currently I am focused on web pentesting. In the future, writeups for machines that are not completely pwned (without root flag) will be updated.

## Hack The Box Write-ups
The table below tracks my progress and methodology for retired HTB machines.
...
| Timing|Linux      | Medium|User flag|
| Node|Linux      | Medium|Remote SSH |
| Enterprise|Linux      |Medium|User flag|
...
LinkedIn: https://www.linkedin.com/in/michael-vavenkov-38b874252/
